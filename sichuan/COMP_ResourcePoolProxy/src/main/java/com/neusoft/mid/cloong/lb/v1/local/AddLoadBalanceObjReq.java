...
public class AddLoadBalanceObjReq  implements java.io.Serializable {
    ...
    private com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] ipPortInfo;
    ...
    public AddLoadBalanceObjReq(
           ...
           com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] ipPortInfo) {
           this.LBID = LBID;
     ...
     * @return ipPortInfo
     */
    public com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] getIpPortInfo() {
        return ipPortInfo;
    }
     ...
     * @param ipPortInfo
     */
    public void setIpPortInfo(com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] ipPortInfo) {
        this.ipPortInfo = ipPortInfo;
    }
    ...
    static {
        ...
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("", "IpPortInfo"));
        typeDesc.addFieldDesc(elemField);
    }
