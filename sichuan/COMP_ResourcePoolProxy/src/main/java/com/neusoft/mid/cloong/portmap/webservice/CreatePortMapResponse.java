...
/**
 * <p>createPortMapResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="createPortMapResponse">
 *   &lt;complexContent>
...
@XmlType(name = "createPortMapResponse", propOrder = {
    "portMapResp"
})
public class CreatePortMapResponse {
