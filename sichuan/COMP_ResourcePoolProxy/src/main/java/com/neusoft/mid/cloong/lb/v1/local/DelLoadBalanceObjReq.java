...
public class DelLoadBalanceObjReq  implements java.io.Serializable {
    ...
    private com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] iPs;
    ...
    public DelLoadBalanceObjReq(
           ...
           com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] iPs) {
           this.LBID = LBID;
           this.iPs = iPs;
    }
     ...
     * @return iPs
     */
    public com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] getIPs() {
        return iPs;
    }
     ...
     * @param iPs
     */
    public void setIPs(com.neusoft.mid.cloong.lb.SOAP.lb.v1.IpPortInfo[] iPs) {
        this.iPs = iPs;
    }
