 ...
 */
public class VMBakRestoreReq extends ReqBodyInfo {

    private RPPVMBakRestoreReq info = new RPPVMBakRestoreReq();

    /**
     * 获取info字段数据
     * @return Returns the info.
     */
    public RPPVMBakRestoreReq getInfo() {
        return info;
    }
     ...
     */
    public void setInfo(RPPVMBakRestoreReq info) {
        this.info = info;
    }
