 ...
 */
public class VlanApplyReq extends ReqBodyInfo {

    private RPPVlanApplyReq info = new RPPVlanApplyReq();

    /**
     * 获取info字段数据
     * @return Returns the info.
     */
    public RPPVlanApplyReq getInfo() {
        return info;
    }
     ...
     */
    public void setInfo(RPPVlanApplyReq info) {
        this.info = info;
    }
