...
import com.neusoft.mid.cloong.rpws.private1072.vm.DeleteVMBackupReq;
import com.neusoft.mid.cloong.rpws.private1072.vm.DeleteVMBackupResp;
...
public class VMBakDelete {
     ...
     * logger
     */
    private static LogService logger = LogService.getLogger(VMBakDelete.class);
     ...
     * @return VMModifyResp
     */
    public RPPVMBakDeleteResp delete(VMBakDeleteReq req) {
        ...
        try {
            ...
            // 生成请求报文体
            DeleteVMBackupReq webserviceReqBody = genWebserviceReqBody(req);
            ...
            // 发送
            DeleteVMBackupResp webserviceRespBody = client.deleteVMBackup(webserviceReqBody, webserviceReqHeader,
     ...
     * @return
     */
    private DeleteVMBackupReq genWebserviceReqBody(VMBakDeleteReq req) {

        DeleteVMBackupReq webserviceReqBody = new DeleteVMBackupReq();
        webserviceReqBody.setVMBackupId(req.getInfo().getVmBackupId());
        webserviceReqBody.setVMBackupInternalID(req.getInfo().getVmBakInternalId());
     ...
     * @param modifyVMResp
     */
    private void assembleResp(RPPVMBakDeleteResp resp, DeleteVMBackupResp webserviceRespBody, String resultCode) {
     ...
     * @return resp
     */
    private RPPVMBakDeleteResp assmbleErrorResp(InterfaceResultCode code) {
        RPPVMBakDeleteResp resp = new RPPVMBakDeleteResp();
