...
public class LBServiceLocator extends org.apache.axis.client.Service implements com.neusoft.mid.cloong.lb.v1.services.LBService {

	
	private static LogService logger = LogService.getLogger(LBServiceLocator.class);
    ...
    public com.neusoft.mid.cloong.lb.v1.interfaces.LBServicePort getLBServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.neusoft.mid.cloong.lb.v1.services.LBServiceSoapBindingStub _stub = new com.neusoft.mid.cloong.lb.v1.services.LBServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.neusoft.mid.cloong.lb.v1.interfaces.LBServicePort.class.isAssignableFrom(serviceEndpointInterface)) {
                com.neusoft.mid.cloong.lb.v1.services.LBServiceSoapBindingStub _stub = new com.neusoft.mid.cloong.lb.v1.services.LBServiceSoapBindingStub(new java.net.URL(LBServicePort_address), this);
                _stub.setPortName(getLBServicePortWSDDServiceName());
                return _stub;
            }
        }
