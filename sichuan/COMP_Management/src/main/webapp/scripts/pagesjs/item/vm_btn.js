...
function saveItem(opt) {
	...
	var urls = "";
	if (opt == 'update') {
		urls = 'vmItemUpdate.action?struts.enableJSONValidation=true';
	} else if (opt == 'save') {
		urls = 'vmItemsCreate.action?struts.enableJSONValidation=true';
	}
...
function saveAndSubmitItem(opt) {
	...
	var urls = "";
	if (opt == 'update') {
		urls = 'vmItemUpdateAndSubmit.action?struts.enableJSONValidation=true&statusCode='+$("#statusCode").val();
	} else if (opt == 'save') {
		urls = 'vmItemCreateAndSubmit.action?struts.enableJSONValidation=true';
	}
	$.ajax({
		type : "POST",
		url : urls,
