...
<div id="main">
	...
	<div id="left">
        ...
        <ul  id="tab">
            <li class="selected">资源视图</li>
            <!-- 点击'业务视图'时，直接跳到所有资源的cpu超标统计action -->
            <li class="fr"><a href="../resourceManagement_appView/cpuExceededAction.action?deviceOverInfo.deviceType=2&deviceOverInfo.performanceType=cpu">业务视图</a></li>
        </ul>
        <div class="left-menu-resourceManagement">
            <ul id="resView" class="ztree" curFun="zyst"></ul>
        </div>
    </div>
    <%-- 右侧 --%>
	<div id="right">
