...
<script type="text/javascript">
	...
	$(function() {
		...
		var ajaxActionStr = '/cpuHistoryPerformanceByAjax.action'
...
<body>
	...
	<div class="details-con">
		...
		<div class="BussHardsoft">
		    <s:form id="searchForm" action="cpuHistoryPerformanceAction.action" method="post">
			...
			<div class="table-sta">
				<table id="listTable" class="BussTable" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<th colspan="2">最大使用率</th>
						<th colspan="2">最小使用率</th>
					</tr>
					<tr>
						<th>使用率</th>
						<th>设备ID</th>
