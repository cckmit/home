...
<script type="text/javascript"
	src="../scripts/pagesjs/report/ioDeviceMonthlyReport.js"></script>
<script type="text/javascript">
	...
	$(function() {
		...
		var	chartTitle = '<b>TOP20-' + deviceTypeName + '磁盘IO平均速率<b>';
		var	yAxisTitle = deviceTypeName + '磁盘IO平均速率(Kbps/s)';
		var	unit = 'Kbps/s';
	...
	<div class="details-con">
		...
		<div class="BussTitle">
			<div class="BussTitleButton" style="width: 450px">
				<a id="cpuUrl" href="#" class="BussTitleButtonLoseFocus"
		...
		<div class="BussHardsoft" style="height: 100px;">
			<s:form id="searchForm" action="ioDevicePerformanceAction.action"
				method="post">
