...
<script type="text/javascript">
	...
	$(function() {
		...
		var ajaxActionStr = '/cpuHistoryPerformanceOverByAjax.action'
...
<body>
	...
	<div class="details-con">
		<!-- 标题栏-->
		<div class="BussTitle">
			<a href="../report/cpuHistoryPerformanceAction.action?historyPerformanceInfo.deviceType=<s:property value="historyPerformanceInfo.deviceType" />&historyPerformanceInfo.performanceType=<s:property value="historyPerformanceInfo.performanceType" />">
			    <div id="performanceStaDiv" class="BussTitle1">使用率统计</div>
			</a> 
			<a href="../report/cpuHistoryPerformanceOverAction.action?historyPerformanceInfo.deviceType=<s:property value="historyPerformanceInfo.deviceType" />&historyPerformanceInfo.performanceType=<s:property value="historyPerformanceInfo.performanceType" />">
		...
		<div class="BussHardsoft">
			<s:form id="searchForm" action="cpuHistoryPerformanceOverAction.action" method="post">
			...
			<div class="BussIllustrate">
				<b>未超标</b>：CPU使用率&lt=70% <b>超标</b>：CPU使用率&gt70%
			</div>
		</div>
