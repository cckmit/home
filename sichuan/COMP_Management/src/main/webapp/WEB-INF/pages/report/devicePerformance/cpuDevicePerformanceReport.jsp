...
<script type="text/javascript" src="../scripts/pagesjs/report/cpuDeviceReport.js"></script>
<script type="text/javascript">
	...
	$(function() {
		...
		var yAxisTitle = "";
		var unit = "";
		if(deviceType =='3'){ // 阵列统计的是读吞吐量
			chartTitle = '<b>TOP10-' + deviceTypeName + '读吞吐量平均值<b>';
			yAxisTitle = deviceTypeName + '读吞吐量平均值(字节)';
			unit = '字节';
		} else if(deviceType =='41' || deviceType =='51'){ // 交换机和路由器端口显示包总数
			chartTitle = '<b>TOP10-' + deviceTypeName + '端口包总数平均值<b>';
			yAxisTitle = deviceTypeName + '端口包总数平均值';
		} else{
			chartTitle = '<b>TOP10-' + deviceTypeName + 'cpu平均使用率<b>';
			yAxisTitle = deviceTypeName + 'CPU平均使用率(%)';
			unit = '%';
		}
