...
<div class="details-con">
	...
	<div class="table-seach">
		...
		<p>
			申请时间：<input type="text"
				onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
				readonly="true" class="Wdate wdatelong" size="23"
				...
				<s:iterator value="#request.itemInfoList">
					<tr>
						...
						<td class="table-opt-block"><a href="javascript:void(0);"
							onclick="onPublishDetail('<s:property value='itemId'/>','<s:property value='itemType.code'/>');return false;">审批</a>
						</td>
					</tr>
				</s:iterator>
			</s:if>
...
<script type="text/javascript"
	src="../scripts/pagesjs/task/publish_list.js"></script>
