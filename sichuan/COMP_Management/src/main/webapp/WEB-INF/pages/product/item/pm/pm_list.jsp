...
<input type="hidden" value="<s:property value='itemCode'/>"
	id="itemCode">
<h1>服务条目管理</h1>
<span class="apply"><a id="apply_host" href="javascript:void(0)">创建物理机条目</a></span>
<div class="details-con">
	<div class="detail-title">
		<h3 class="apply-title">物理机条目管理</h3>
		<ul class="title-btn">
	...
	<div class="table-seach">
		...
		<p>
			创建时间：<input type="text" id="beginCreateTime"
				...
				readonly="true" class="Wdate wdatelong" class='3h' size="23"
				maxlength="14" />至<input id="endCreateTime"
				onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"
				readonly="true" class="Wdate wdatelong" class='3h' maxlength="14"
				type="text" size="23" />
		</p>
		<ul class="opt-btn fr">
...
<script type="text/javascript" src="../scripts/pagesjs/item/pm/pm_list.js"></script>