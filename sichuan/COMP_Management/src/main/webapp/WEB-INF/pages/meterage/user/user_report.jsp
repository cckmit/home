	...
	<div id="message" style="display: none;">
		...
		<span class="success"><s:actionmessage /></span>
   	  ...
   	  <div class="details-con">
          ...
          <h3 class="apply-title">租户计量报告</h3>
   	    </div>
        <div class="table-seach">
        	<p>
        	租户：<input type='text' id='userid' readonly="readonly" /><a class="search" href="javascript:void(0);" id="searchUser">查询用户</a>
            </p>
        	<p>
...
<script type="text/javascript" src="../scripts/pagesjs/meterage/user_report.js"></script>
