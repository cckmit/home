...
var actionStr = '/diskUsedPerListAction.action';//业务下性能列表传参
var performanceTbodyId = "diskPerTbody";//性能列表tbody id 

//加载图表数据
$(function() {
	x_axisData = <s:property value="x_axisData"/>;
	y_axisData = <s:property value="y_axisData"/>;
	//appId = <s:property value="appIdJSON"/>;
	...
	//加载表格数据
	actionStr = "/diskUsedPerListAction.action?device_type="+device_type+"&appId="+appId+"&nodeId="+nodeId+"&treeNodeName="+treeNodeName;
     ...
     <div class="details-con" style="height: 510px;"> 
         ...
         <div class="BussHardsoft" >
         	<ul>
                ...
                <li id="diskLi" class="BussHardsoftFourc">
         ...
         <!--  
         <div class="BussUse" >
         	<div class="BussUseTitl"><b>磁盘使用率统计</b></div>
         </div>
         -->
