...
<script type="text/javascript">
	...
	$(function() {
			...
			plotOptions : {
				column : {
					...
					dataLabels : {
						...
						formatter : function() {
							if (this.point.per != 0) {
								return Math.round(this.point.per) + '%';
							} else {
								return '';
							}
						},
		...
		/****************************chartInt DEMO end************************************************/
		getExceededData('/cpuExceededPerListByAjax.action?deviceOverInfo.deviceType=' + '<s:property value="deviceOverInfo.deviceType" />',
				'ExceededTbody', 'pageBarPerDiv', PerTbodyAccess);

		getExceededData('/cpuExceededNumListByAjax.action?deviceOverInfo.deviceType=' + '<s:property value="deviceOverInfo.deviceType" />',
