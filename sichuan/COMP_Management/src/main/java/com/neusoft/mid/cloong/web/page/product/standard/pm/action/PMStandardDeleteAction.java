 ...
 * @version $Revision 1.0 $ 2014-1-17 上午10:06:33
 */
public class PMStandardDeleteAction extends BaseStandardDeleteAction {

    private static final long serialVersionUID = 958846070263624648L;

    private static LogService logger = LogService.getLogger(PMStandardDeleteAction.class);
    ...
    public String execute() {
        ...
        try {
            ...
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION, "删除物理机规格失败", e);
        ...
        try {
            ...
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
                    "删除物理机规格失败！原因：查询规格是否被同步过时，数据库异常。", e);
            resultPath = ConstantEnum.ERROR.toString();
            return ConstantEnum.SUCCESS.toString();
        } catch (Exception e) {
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
    ...
    /**
     * updateData 更新数据(删除物理机规格信息\删除同步表信息)
    ...
    private void updateDataBatch(String standardId,
        ...
        try {
            ...
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
                    "删除物理机规格失败！原因：调用同步删除接口后，查询规格是否存在未同步过时，数据库异常。", e);
            resultPath = ConstantEnum.ERROR.toString();
        } catch (Exception e) {
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
                    "删除物理机规格失败！原因：调用同步删除接口后，查询规格是否存在未同步过时，数据库异常。", e);
        ...
        batchVOs.add(new BatchVO("MOD", "deletePMStandard", standardId));
    ...
    /***
     * updateDataStandard 未同步过,删除物理机规格
     * @param standardId 规格ID
     */
    public void updateDataStandard(String standardId) {
        ...
        try {
            ...
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
                    "删除物理机规格失败！原因：查询规格是否存在未同步过时，数据库异常。", e);
            resultPath = ConstantEnum.ERROR.toString();
        } catch (Exception e) {
            logger.error(CommonStatusCode.DATABASE_OPERATION_ECXEPTION,
                    "删除物理机规格失败！原因：查询规格是否存在未同步过时，数据库异常。", e);
