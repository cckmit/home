 ...
 */
public class VMStandardModifyAction extends BaseStandardModifyAction {

    private static LogService logger = LogService.getLogger(VMStandardModifyAction.class);
    ...
    public String execute() {
        ...
        batchVos.add(new BatchVO("MOD","updateVMStandard",vmStandardInfo));
