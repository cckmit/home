 ...
 */
public class RtInfoDetailAction extends ResourceManagementBaseAction {
     ...
     * 日志打印对象
     */
    private static LogService logger = LogService.getLogger(RtInfoDetailAction.class);
    ...
    public String execute() {
        try {
        	this.rtInfo = (RtInfo) this.ibatisDAO.getSingleRecord("queryRtInfo", rtInfo);
        } catch (Exception e) {
