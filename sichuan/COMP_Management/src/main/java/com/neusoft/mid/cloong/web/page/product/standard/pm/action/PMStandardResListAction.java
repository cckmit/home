 ...
 */
public class PMStandardResListAction extends BaseAction {

    private static final long serialVersionUID = -7447229274558674923L;

    private static LogService logger = LogService.getLogger(PMStandardResListAction.class);
    ...
    private List<StandardResListInfo> osInfos;
    ...
    public String execute() {
        ...
        try {
            ...
            osInfos = ibatisDAO.getData("queryPMOSList",null);
	 ...
	 * @return the osInfos
	 */
	public List<StandardResListInfo> getOsInfos() {
		return osInfos;
	}
	 ...
	 */
	public void setOsInfos(List<StandardResListInfo> osInfos) {
