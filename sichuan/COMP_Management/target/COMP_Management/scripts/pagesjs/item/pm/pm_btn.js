...
function saveItem(opt) {
	...
	var urls = "";
	if (opt == 'update') {
		urls = 'pmItemUpdate.action?struts.enableJSONValidation=true';
	} else if (opt == 'save') {
		urls = 'pmItemsCreate.action?struts.enableJSONValidation=true';
	}
...
function saveAndSubmitItem(opt) {
	...
	var urls = "";
	if (opt == 'update') {
		urls = 'pmItemUpdateAndSubmit.action?struts.enableJSONValidation=true&statusCode='+$("#statusCode").val();
	} else if (opt == 'save') {
		urls = 'pmItemCreateAndSubmit.action?struts.enableJSONValidation=true';
	}
	$.ajax({
		type : "POST",
		url : urls,
