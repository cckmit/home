	...
	<div class="login-info">
        ...
        <div class="login-float-bg">
            <div class="login-float-top">
                	...
                	<hr class="login-line"/>
                	<div>系统已向您注册的手机发送了一个短信验证码，请注意查收！</div>
            		<form id="formSubmit" name="formSubmit" method="post" action="shortMessageConfirm.action" >
						<div id="detail_tab_info" class="login-detail-font">
							<s:hidden name="userId" />
							<div><span><font class="red-font">*</font>短信验证码:</span><s:textfield id="shortMessage" name="shortMessage"/></div>
							<div><font class="red-font"><s:property value="errMsg" /><label id="errParam"></label></font></div>
							<div class="login-detail-btn"><input type="submit" class="submit" onclick="submitform()" value="确认" />
						</div>
					</form>
        	</div>
        </div>
