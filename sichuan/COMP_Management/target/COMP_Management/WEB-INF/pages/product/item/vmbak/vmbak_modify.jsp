...
<%@ taglib prefix="s" uri="/struts-tags"%>
      ...
      <div class="details-con">
          ...
          <h3 class="apply-title">修改虚拟机备份条目</h3>
   	    </div>
        <!-- form -->
		<div class="page-form">
        	<div class="section">
    ...
    <div class="page-form" id="relate_resource_div" style="display:none;">
        <div class="section">
        	<div class="table-seach">
                ...
                <p>卷大小(GB):<input type="text" size="8" id="queryDiscSize"/>
                </p>
            </div>
            <div class="table-seach">
            	<ul class="opt-btn">
...
<script type="text/javascript" src="../scripts/pagesjs/item/vmbak/vmbak_modify.js"></script>