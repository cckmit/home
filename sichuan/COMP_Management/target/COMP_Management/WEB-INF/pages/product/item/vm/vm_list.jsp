...
<input type="hidden" value="<s:property value='itemCode'/>"
	id="itemCode">
<h1>服务条目管理</h1>
<span class="apply"><a id="apply_host" href="javascript:void(0)">创建虚拟机条目</a></span>
<div class="details-con">
	<div class="detail-title">
		<h3 class="apply-title">虚拟机条目管理</h3>
		<ul class="title-btn">
...
<script type="text/javascript" src="../scripts/pagesjs/item/vm_list.js"></script>