...
<%@ taglib prefix="s" uri="/struts-tags"%>
	<div id="message" style="display: none;">
      ...
      <div class="details-con">
          ...
          <h3 class="apply-title">创建虚拟机条目</h3>
   	    </div>
        <!-- form -->
		<div class="page-form">
        	<div class="section">
    ...
    <div class="page-form" id="relate_resource_div" style="display:none;">
        <div class="section">
        	<div class="table-seach">
                ...
                <p>CPU数量(个):<input type="text" size="8" id="queryCpuNum"/>
                </p>
                <p>磁盘空间(GB):<input type="text" size="8" id="queryDiscSize"/>
                </p>
                <p>内存容量(MB):</p>
                <p><select class="select-min" id="queryRamSize">
...
<script type="text/javascript" src="../scripts/pagesjs/item/vm_add.js"></script>