...
<%@ taglib prefix="s" uri="/struts-tags"%>
      ...
      <div class="details-con">
          ...
          <h3 class="apply-title">创建云硬盘条目</h3>
   	    </div>
        <!-- form -->
		<div class="page-form">
        	<div class="section">
        	<input type="hidden" value="" id="standardId" name="standardId">
                ...
                <div class="field">
                    ...
                    <div class="content">
                      <input type="text" size="28"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="true" cssClass="Wdate wdatelong" maxlength="14" value="" id="sellStartTime"/>(如不填写默认当前系统时间,通过后立即生效)
                    </div>
                    <div class="point"></div>
                </div>
                <div class="field">
                    ...
                    <div class="content">
                      <input type="text" size="28" maxlength="14" value="" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="true" cssClass="Wdate wdatelong" id="sellEndTime"/>(如不填写长期有效)
                    </div>
                    <div class="point"></div>
                </div> -->
                <div class="field">
...
<script type="text/javascript" src="../scripts/pagesjs/item/ebs/ebs_add.js"></script>