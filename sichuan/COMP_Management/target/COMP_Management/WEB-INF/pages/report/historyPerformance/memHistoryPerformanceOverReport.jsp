...
<script type="text/javascript">
	...
	$(function() {
		...
		var ajaxActionStr = '/memHistoryPerformanceOverByAjax.action'
...
<body>
	...
	<div class="details-con">
		...
		<div class="BussHardsoft">
			<s:form id="searchForm" action="memHistoryPerformanceOverAction.action" method="post">
