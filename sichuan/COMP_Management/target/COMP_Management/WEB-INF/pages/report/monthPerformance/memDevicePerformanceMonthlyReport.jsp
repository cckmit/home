...
<script type="text/javascript"
	src="../scripts/pagesjs/report/memDeviceMonthlyReport.js"></script>
<script type="text/javascript">
	...
	$(function() {
		...
		var	chartTitle = '<b>TOP20-' + deviceTypeName + '内存平均使用率<b>';
		var	yAxisTitle = deviceTypeName + '内存平均使用率(%)';
		var	unit = '%';
...
<body>
	...
	<div class="details-con">
		...
		<div class="BussHardsoft" style="height: 100px;">
			<s:form id="searchForm" action="memDevicePerformanceAction.action"
				method="post">
