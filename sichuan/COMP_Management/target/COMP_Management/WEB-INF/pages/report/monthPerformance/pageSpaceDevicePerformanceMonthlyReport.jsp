...
<script type="text/javascript"
	src="../scripts/pagesjs/report/pageDeviceMonthlyReport.js"></script>
<script type="text/javascript">
	...
	$(function() {
		...
		var	chartTitle = '<b>TOP20-' + deviceTypeName + 'page space平均使用率<b>';
		var	yAxisTitle = deviceTypeName + 'page space平均使用率(%)';
		var	unit = '%';
...
<body>
	...
	<div class="details-con">
			...
			<div class="BussTitleButton" style="width: 450px">
				<a id="cpuUrl" href="#" class="BussTitleButtonLoseFocus"
					...
					onclick="setPerformanceUrl(<s:property value="monthPerformanceInfo.deviceType" />, 'mem')"><div
						id="memDiv" class="">内存</div></a> <a id="pageUrl" href="#"
					class="BussTitleButtonFocus"
		...
		<div class="BussHardsoft" style="height: 100px;">
			<s:form id="searchForm" action="pageSpaceDevicePerformanceAction.action"
				method="post">
