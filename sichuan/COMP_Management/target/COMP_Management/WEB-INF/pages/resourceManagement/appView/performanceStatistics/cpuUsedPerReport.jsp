...
var actionStr = '/cpuUsedPerListAction.action';//业务下性能列表传参
var performanceTbodyId = "cpuPerTbody";//性能列表tbody id 
...
$(function() {
	...
	//加载表格数据
    actionStr = "/cpuUsedPerListAction.action?device_type="+device_type+"&appId="+appId+"&nodeId="+nodeId+"&treeNodeName="+treeNodeName;
    ...
    <!-- 设备数 -->
     ...
     <div class="details-con" style="height: 510px;">
         ...
         <div class="BussHardsoft" >
         	<ul>
            	<li id="cpuLi" class="BussHardsoftFourc">
         ...
         <!--  
         <div class="BussUse" >
         	<div class="BussUseTitl"><b>CPU使用率统计</b></div>
         </div>
         -->
