...
<%@ taglib prefix="s" uri="/struts-tags"%>
      ...
      <div class="details-con">
   	    <div class="detail-title">
            ...
            <h3 class="apply-title">物理机订单审批</h3>
   	    </div>
        <!-- form -->
		<!-- 虚拟机订单详细信息 -->
		...
		<div class="content"><input type="text" size="28" id="pmServerType"
			value="${stardardInfo.serverType}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		<div class="caption">CPU单元数量：</div>
		<div class="content"><input type="text" size="28" id="pmCpuNum"
			value="${stardardInfo.cpuNum}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		</div>
		<div class="field">
		<div class="caption">内存容量：</div>
		<div class="content"><input type="text" size="28" id="pmRamSize"
			value="${stardardInfo.ramSize}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		<div class="caption">硬盘空间(G)：</div>
		<div class="content"><input type="text" size="28" id="pmDiscSize"
		...
		<div class="field">        
		    ...
		    <div class="content"><textarea cols="40" rows="3" id="pmAuditInfo"></textarea></div>
		    <div class="point"></div>
		</div>
            ...
            <div class="page-button">
                <ul class="opt-bottom-btn">
                    <li>
                    	<a href="javascript:void(0);" onclick="auditPMPass();return false;">通过</a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" onclick="auditPMNoPass();return false;">不通过</a>
                    </li>
                    <li>
