...
<%@ taglib prefix="s" uri="/struts-tags"%>
      ...
      <div class="details-con">
   	    <div class="detail-title">
            ...
            <h3 class="apply-title">虚拟机订单审批</h3>
   	    </div>
        <!-- form -->
		<!-- 虚拟机订单详细信息 -->
		...
		<div class="field">
		<div class="caption">CPU单元数量(核)：</div>
		<div class="content"><input type="text" size="28" id="cpuNum"
			value="${stardardInfo.cpuNum}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		<div class="caption">内存容量(M)：</div>
		<div class="content"><input type="text" size="28" id="ram"
			value="${stardardInfo.ramSize}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		</div>
		<div class="field">
		<div class="caption">硬盘空间(G)：</div>
		<div class="content"><input type="text" size="28" id="disk"
			value="${stardardInfo.discSize}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		<div class="caption">操作系统：</div>
		<div class="content"><input type="text" size="28" id="os"
			value="${osInfo.osName}" style="border: 1px;" readonly="readonly" /></div>
		<div class="point"></div>
		</div>
		<div class="field">
		...
		<div class="field">        
		    ...
		    <div class="content"><textarea cols="40" rows="3" id="vmAuditInfo"></textarea></div>
		    <div class="point"></div>
		</div>
            ...
            <div class="page-button">
                <ul class="opt-bottom-btn">
                    <li>
                    	<s:if test="orderInfo.standardType==11">
                    		<a href="javascript:void(0);" onclick="auditVmGhostPass();return false;">通过</a>
                    	</s:if>
                    	<s:if test="orderInfo.standardType==0">
                    		<a href="javascript:void(0);" onclick="auditVMPass();return false;">通过</a>
                    	</s:if>
                    </li>
                    <li>
                    	<s:if test="orderInfo.standardType==11">
                    		<a href="javascript:void(0);" onclick="auditVmGhostNoPass();return false;">不通过</a>
                    	</s:if>
                    	<s:if test="orderInfo.standardType==0">
                    		<a href="javascript:void(0);" onclick="auditVMNoPass();return false;">不通过</a>
                    	</s:if>
                    </li>
                    <li>
