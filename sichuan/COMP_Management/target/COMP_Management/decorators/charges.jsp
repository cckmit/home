...
<div class="head-logo"></div>
		...
		<div>
			<ul id="head-menu" class="head-btn">
				...
				<comp-identify:COMPIdentify permissionname="zfgl">
					<li class="head-btn-sel"><a href="../charges/queryChargesAction.action?chargesType=0">资费管理</a> </li>
				</comp-identify:COMPIdentify>
	...
	<div id="main">
		...
		<div id="left">
			...
			<ul class="left-menu">
				<comp-identify:COMPIdentify permissionname="zfgl">
					<li><span class="ico_system"></span><a
						href="../charges/queryChargesAction.action?chargesType=0">资费管理</a></li>
				</comp-identify:COMPIdentify>
					<li class="menu-child">
					  		<comp-identify:COMPIdentify permissionname="xnjzfgl">
					  			<dl style="text-indent: 9px;"><a href="../charges/queryChargesAction.action?chargesType=0">虚拟机</a></dl>
					  		</comp-identify:COMPIdentify>
					  		<comp-identify:COMPIdentify permissionname="yypzfgl">
					  			<dl style="text-indent: 9px;"><a href="../charges/queryChargesAction.action?chargesType=1">云硬盘</a></dl>
					  		</comp-identify:COMPIdentify>
					</li>
			</ul>
		</div>
