 ...
 * @version $Revision 1.1 $ 2013-3-7 下午02:09:48
 */
public class Base64 {
 ...
 *            No line separator will be in breach of RFC 2045 which specifies max 76 per line
 *            but will be a little faster.
...
public static final String encode(String s) {
    ...
    // StringBuffer/Builder would be slower.
    try {
        return new String(encodeToChar(s.getBytes("UTF-16BE"), false));
    } catch (UnsupportedEncodingException e) {
        throw new RuntimeException(e);
    }
}
...
public static String decode(String s) throws UnsupportedEncodingException {
    return new String(Base64.decodeFast(s), "UTF-16BE");
}

public static String decode(String s, String encoding) throws UnsupportedEncodingException {
    return new String(Base64.decodeFast(s), encoding);
}
