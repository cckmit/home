/*******************************************************************************
 * @(#)PMOperatorType.java 2015年2月26日
 *
...
public enum PMOperatorType {
    ...
    private PMOperatorType(int value) {
        this.value = value;
    }
     ...
     * @return 码值对应的枚举实例
     */
    public static PMOperatorType fromValue(int v) {
        for (PMOperatorType c : PMOperatorType.values()) {
            if (c.value == v) {
                return c;
            }
        }
     ...
     * @return 码值对应的枚举实例
     */
    public static PMOperatorType fromValue(String v) {
        for (PMOperatorType c : PMOperatorType.values()) {
