/*******************************************************************************
 * @(#)VmBakRestoreImpl.java 2015-3-10
 *
 ...
 */
public class VmBakRestoreImpl implements VmBakRestore,Serializable{
	...
	private static LogService logger = LogService.getLogger(VmBakRestoreImpl.class);
     ...
     */
    @Override
    public RPPVMBakRestoreResp restoreVmBak(RPPVMBakRestoreReq vmBakReq) {
    ...
    private RuntimeContext assembleRuntimeContext(RPPVMBakRestoreReq vmBakReq) {
    	RuntimeContext req = new RuntimeContext();
        req.setAttribute(RPPBaseReq.REQ_BODY, vmBakReq);
        return req;
    }

    private RPPVMBakRestoreResp assembleResp(HttpSyncRespData resp) {
    	RPPVMBakRestoreResp vmBakResp = (RPPVMBakRestoreResp) resp.getRuntimeContext().getAttribute(RPPBaseResp.RESP_BODY);
        return vmBakResp;
    }

    private RPPVMBakRestoreResp assmbleErrorResp(CommonStatusCode code, String errorMessage) {
    	RPPVMBakRestoreResp vmBakResp = new RPPVMBakRestoreResp();
