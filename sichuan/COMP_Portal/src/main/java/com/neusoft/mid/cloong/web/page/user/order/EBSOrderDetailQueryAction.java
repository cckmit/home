...
import com.neusoft.mid.cloong.web.page.console.disk.info.EBSStandardInfo;
 ...
 */
public class EBSOrderDetailQueryAction extends BaseAction {

    private static final long serialVersionUID = -3291560302940406846L;

    private static LogService logger = LogService.getLogger(EBSOrderDetailQueryAction.class);
     ...
     * 云硬盘规格信息
     */
    private EBSStandardInfo stardardInfo;
    ...
    public String execute() {
        ...
        try {
            ...
            stardardInfo = (EBSStandardInfo) ibatisDAO.getSingleRecord("queryEBSStardInfo",
    ...
    public EBSStandardInfo getStardardInfo() {
        return stardardInfo;
    }
