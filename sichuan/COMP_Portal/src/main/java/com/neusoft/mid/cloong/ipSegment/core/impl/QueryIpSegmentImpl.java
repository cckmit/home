 ...
 * @version $Revision 1.0 $ 2015年3月6日 上午9:38:03
 */
public class QueryIpSegmentImpl implements QueryIpSegment {

    private static LogService logger = LogService.getLogger(QueryIpSegmentImpl.class);
    ...
    private RPPIPQueryResp assmbleErrorResp(CommonStatusCode code, String errorMessage) {
    ...
    private RPPIPQueryResp assembleResp(HttpSyncRespData resp) {
        RPPIPQueryResp ipResp = new RPPIPQueryResp();
