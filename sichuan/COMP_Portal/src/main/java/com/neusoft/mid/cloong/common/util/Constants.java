...
public final class Constants {
    ...
    public static String  mailIsSSL =null;
    public static String  mailServiceIp =null;
    public static int  mailServicePort;
    public static String  username =null;
    public static String  password =null;
    public static String  sendmailfrom =null;
    public static String  validateSimple =null;
    public static String  enclosurePath =null;
    public static String  mailNoticeFlag =null;
    ...
    static {
        ...
        if (null != is) {
            ...
            try {
                ...
                mailIsSSL = prop.getProperty("mailIsSSL").trim();
                mailServiceIp = prop.getProperty("mailServiceIp").trim();
                mailServicePort = Integer
                        .parseInt(prop.getProperty("mailServicePort").trim());
                username = prop.getProperty("sendmailuser").trim();
                password = prop.getProperty("sendmailpasswd").trim();
                sendmailfrom = prop.getProperty("sendmailfrom").trim();
                validateSimple = prop.getProperty("validateSimple").trim();
                enclosurePath = prop.getProperty("enclosure.path").trim();
                mailNoticeFlag = prop.getProperty("mailNoticeFlag").trim();
            } catch (IOException e) {
