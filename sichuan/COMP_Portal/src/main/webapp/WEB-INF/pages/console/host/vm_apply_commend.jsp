...
<div class="self-config">
	...
	<s:form id="vmApplyInfoAction" name="vmApplyInfoAction"
		action="vmApplyInfoAction.action" method="post">
		...
		<div class="config-content">
			...
			<div>
				...
				<s:if test="#session.userInfo.userId=='admin'">
					...
					<span id="bindDiv" class="col-content"><a class=""
		...
		<div class="config-content" style="margin-bottom: 200px;">
			...
			<div>
				<span class="col-name">BOSS订购实例号码</span><span class="col-content"><input
					type="text" size="30" id="vmBossOrderId" name="vmBossOrderId"
					class="max-text" /></span>
			</div>
		</div>
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/host/vm_apply_commend.js"></script>
<script>
