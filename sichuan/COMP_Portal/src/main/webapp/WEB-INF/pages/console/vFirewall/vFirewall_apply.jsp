...
<div class="self-config">
	...
	<s:form action="vFWApplyInfoAction.action" method="post">
		<div class="config-content">
			<h3>基础配置</h3>
			<span class="col-name">虚拟防火墙名称</span><span class="col-content"><input
				type="text" size="25" id="fwName" name="fwName" value="" /></span>
			<div>
		...
		<%--	<span class="col-name">所属企业客户</span><span class="col-content"
			...
			<div>
				<span class="col-name">描述</span><span class="col-content"><input
					class="max-text" type="text" id="desc" name="description" /></span>
			</div>
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/vFirewall/vFirewall_apply.js"></script>
