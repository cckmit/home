...
<!-- 隐藏域记录appId和appName -->
<input type="hidden" value=${param.appId} id="param-appId" name="appId"/>
<input type="hidden" value=${param.appName} id="param-appName" name="caseId"/>
<span class="apply">
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/business/host/pm_detail.js"></script>