...
<div class="details-con">
	...
	<input type="hidden" id="vlanId"
		value="<s:property value='vlan.vlanId' />"> <input
	...
	<div class="detail-title">
		<a href="#" onclick="goBackForm('','');" title="返回"> <span
			class="back"></span>
		</a>
		<h2 id="titleDesc">
	...
	<div class="detail-info apply-info vh-info-h">
		<div id="hd_div" class="tagInfo apply-info-top">
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/ipSegment/ipSegment_detail.js"></script>
