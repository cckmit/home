...
<div class="list">
	...
	<div class="list-items ">
		<s:if test="ips.size()>0">
			<ul id="resultList" class="items">
				<s:iterator value="ips">
					<li>
					<a href="ipDetail.action?caseId=<s:property value='caseId' />">
						<div
							class="item-status 
						...
						<div class="item-content">
							...
							<div class="detail">
								...
								<div class="detail-col">
									<div class="detail-row">
										<span>绑定主机：</span> <span>	<s:property value="hostName" /></span>
									</div>
									<div class="detail-row">
										<span>创建时间：</span> 
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/ip/ip_list.js"></script>
