...
<script type="text/javascript"
	src="../scripts/pagesjs/console/business/common.js"></script>
<link rel="stylesheet" href="../styles/zTreeStyle.css" type="text/css">
<script type="text/javascript"
	src="../scripts/lib/jquery.ztree.core-3.5.js"></script>
<script type="text/javascript"
	src="../scripts/pagesjs/console/business/zTreeOnload.js"></script>
...
<!-- 			<p>控制台</p></a> -->
		...
		<ul class="login">
			...
			<li class="resource"><a
				href="../business_console/businessOverview.action" class="active">业务视图</a></li>
			<li class="resource"><a
				href="../alarmCenter/alarmAction.action">告警</a></li>
			<li class="resource"><a
