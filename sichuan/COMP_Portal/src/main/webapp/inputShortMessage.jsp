...
<s:form id="formSubmit"  name="formSubmit" method="post" action="shortMessageConfirm.action" >
...
<div class="btn"><input type="submit" id="btnRegister" onclick="submitform()" value="确认" /></div>
</div>
</s:form>
</div>
</div>
