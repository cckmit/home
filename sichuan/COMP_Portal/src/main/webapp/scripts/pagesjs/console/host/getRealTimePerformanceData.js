...
//			if(obj.usedPer != null ){
//				if("CPU" == staType){
//					$('#'+dataTbody).append('<li><p style="font-size:12px; font-weight:normal;line-height:20px;color:#666;">当前CPU使用率:'+obj.usedPer+'%</p></li>');
//				}else if("MEM" == staType){
//					$('#'+dataTbody).append('<li><p style="font-size:12px; font-weight:normal;line-height:20px;color:#666;">当前内存使用率:'+obj.usedPer+'%</p></li>')
//				    				.append('<li><p style="font-size:12px; font-weight:normal; line-height:20px; color:#666;">当前可用内存量:'+obj.memFree+'(GB)</p></li>');
//				}
//			}else{
//				if("CPU" == staType){
