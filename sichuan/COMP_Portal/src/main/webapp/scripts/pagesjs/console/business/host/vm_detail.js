...
var $startBtn = '<li id="start"><a href="#" class="start" onclick="resumeHost()">恢复</a></li>';
var $backBtn = '<li id="backup"><a href="#" class="backup" onclick="backupHost()">备份</a></li>';
...
if(data.length>0){
	...
	$.each(data, function(index) {
		...
		$('<tr>').appendTo('#listTspan').append(
			...
			'<td class="table-opt-block"><a href="#" onclick="renewSnapshot(\''
					+ this.snapshot_id
					+ '\');">恢复</a><a href="#" onclick="delSnapshot(\''
