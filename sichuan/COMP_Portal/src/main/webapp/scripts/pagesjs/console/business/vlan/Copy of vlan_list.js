...
function deleteVlan(vlanName, vlanId, resPoolId, resPoolPartId) {
	$.dialog({
		...
		ok : function() {
			...
			window.location = "vlanCancelAction.action?vlanId=" + vlanId + "&resourcePoolId=" + resPoolId + "&resourcePoolPartId=" + resPoolPartId
					+ '&nodeType=' + nodeType + '&nodeId=' + nodeId + '&treeNodeName=' + treeNodeName + '&pnodeId=' + pnodeId + '&pnodeName='
					+ pnodeName + '&appId=' + appId + '&curFun=' + curFun;
		},
		cancelVal : '取消',
		cancel : true,
		lock : true
