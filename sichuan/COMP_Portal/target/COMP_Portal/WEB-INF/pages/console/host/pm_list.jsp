...
<span class="apply"><a href="pmApplyAction.action">申请物理机</a></span>
<!-- 查询条件 -->
<div class="table-seach" style="float: left">
	...
	<ul class="opt-btn fr">
		<li><a class="search" href="#" onclick="queryPm()">查询</a></li>
	</ul>
</div>
<!-- 主机列表 -->
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/host/pm_list.js"></script>
