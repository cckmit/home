...
<div class="list">
	...
	<div class="list-items ">
		<s:if test="fsList.size()>0">
			<ul id="resultList" class="items">
				<s:iterator value="fsList">
					<li><a
						href="fileStoreDetail.action?caseId=<s:property value='caseId' />">
							<div
								class="item-status 
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/fileStore/fileStore_list.js"></script>