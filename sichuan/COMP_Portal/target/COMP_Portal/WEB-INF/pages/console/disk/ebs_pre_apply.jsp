...
<div class="self-config">
	...
	<s:form id="ebsPreApplyInfoAction" name="ebsPreApplyInfoAction"
		action="ebsPreApplyInfoAction.action" method="post">
...
<script type="text/javascript"
	src="../scripts/pagesjs/console/disk/ebs_pre_apply.js"></script>
