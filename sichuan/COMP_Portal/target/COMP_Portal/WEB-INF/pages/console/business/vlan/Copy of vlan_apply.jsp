...
<div id="right">
	...
	<s:form action="vlanApplyInfoAction.action" method="post" id="vlanForm">
		...
		<div class="details-con">
			<div class="detail-title">
				<a href="vlanQueryListAction.action?queryBusinessId=<s:property value='queryBusinessId' />&nodeType=<s:property value="nodeType" />
					&nodeId=<s:property value="nodeId" />&treeNodeName=<s:property value="treeNodeName" />&pnodeId=<s:property value="pnodeId" />
					&pnodeName=<s:property value="pnodeName" />&appId=<s:property value="appId" />&curFun=<s:property value="curFun" />" title="返回">
					<span class="back"></span>
				</a>
				<h3 class="apply-title">创建Vlan</h3>
			</div>
			<div class="detail-info apply-info-l apply-info">
				<div class="apply-info-top">
					<span class="apply-span-name">名称：</span> <input
						class="vh-input-max" type="text" size="25" id="vlanName"
						name="vlanName" value="" />
				</div>
				...
				<div id="bindDiv" class="apply-info-line-top">
					...
					<input type="hidden" name="appName" value="<s:property value="businessName" />" />
					<input type="hidden" name="appId" value="<s:property value='queryBusinessId' />" />
				</div>
