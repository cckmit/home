...
<div><span><font class="red-font">*</font>用户账号:</span><s:textfield id="userId" name="user.userId"/></div>
<div><span><font class="red-font">*</font>用户姓名:</span><s:textfield id="userName" name="user.userName"/></div>
...
<s:textfield id="mobile" name="user.mobile"/></div>
<div><span><font class="red-font">*</font>邮箱:</span>
<s:textfield id="email" name="user.email" /></div>
<div><span>用户地址:</span>
<s:textfield id="address" name="user.address" /></div>
<div><span>固话号码:</span>
<s:textfield id="telphone" name="user.telphone" /></div>
<div><span>传真号码:</span>
<s:textfield id="fax" name="user.fax" /></div>
<div><span>部门名称:</span>
<s:textfield id="departmentName" name="user.departmentName" /></div>
<div><span>描述信息:</span>
<s:textfield id="desc" name="user.desc" /></div>
<div>
...
<div><font class="red-font"><s:property value="errMsg" /><label id="errParam">注册申请已提交，请等待审核！</label></font></div>
