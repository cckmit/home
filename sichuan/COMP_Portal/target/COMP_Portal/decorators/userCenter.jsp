...
<body>
	...
	<div>
		...
		<ul class="login">
			<li class="resource"><a
				href="../console/resourcesOverviewAction.action" >资源视图</a>
			</li>
			<li class="resource"><a
			...
			<li class="app"><a href="../userCenter/orderQuery.action"
				class="active">用户中心</a></li>
	...
	<div id="left" class="left-menu">
		...
		<div id="userOrder" class="menu-item">
			<i></i> <a href="orderQuery.action">用户订单</a><i class="arrow"></i>
		</div>

		<div id="userInfo" class="menu-item">
			<i></i> <a href="userInfo.action">用户信息</a><i class="arrow"></i>
		</div>
		<div id="updatePwd" class="menu-item">
			<i></i> <a href="modifyPassword.action">修改密码</a><i class="arrow"></i>
		</div>
	</div>
